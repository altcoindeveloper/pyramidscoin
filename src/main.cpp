...
//    else if(nHeight > 100 && nHeight <= 766666)
    else if(nHeight > 100 && nHeight <= 299999)
    {
       nSubsidy = 90 * COIN;
    }
    else if(nHeight > 299999 && nHeight <= 419999)
    {
       nSubsidy = 45 * COIN;
	   nSubsidy >>= ( (nHeight - 300000) / 20000);
    }
    else //(nHeight > 420000)
    {
       nSubsidy = 1 * COIN;
...
*/
	/*
		nHeight = 300000
		1) nSubsidy = 45
		2) (300000 - 300000) / 20000 = 0
		45d = 101101b >>= 0 == 101101b
		
		nHeight = 320000
		1) nSubsidy = 45
		2) (320000 - 300000) / 20000 = 1
		45d = 101101b >>= 1 == 010110b = 22
		
		nHeight = 340000
		1) nSubsidy = 45
		2) (340000 - 300000) / 20000 = 2
		45d = 101101b >>= 2 == 001011b = 11
		
		nHeight = 400000
		1) nSubsidy = 45
		2) (400000 - 300000) / 20000 = 5
		45d = 101101b >>= 2 == 000001b = 1
